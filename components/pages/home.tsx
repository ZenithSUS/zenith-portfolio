...
export default function Home() {
  ...
  return (
    <motion.section
      id="home"
      className="flex min-h-screen w-full flex-col items-center justify-center overflow-hidden px-4 py-16 text-center sm:px-8 sm:py-20"
      initial={{ opacity: 0 }}
      ...
      <div className="flex w-full flex-col items-center justify-evenly md:flex-row md:gap-10">
        ...
        <div className="relative z-10">
          ...
          >
            ...
            >
              Hi, I am{" "}
              <span className="glow-blue text-primary drop-shadow-lg">
                Jeran
              </span>
            </motion.h1>
